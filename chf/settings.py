...
SECRET_KEY = 'rqmi%i$78d22&8qch-&tad8ymr=(1rvwn90n57nxr&8(6fj$2n'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'chf',#os.path.join(BASE_DIR, 'db.sqlite3'),
        'USER': 'postgres',
        'PASSWORD': 'Password1',
        'HOST': '127.0.0.1',
        'PORT': '5432'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'colonialheritagefoundation42@gmail.com'
EMAIL_HOST_PASSWORD = 'elevatedcrossfit'
